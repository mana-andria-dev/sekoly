    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('classrooms')) {
            Schema::create('classrooms', function (Blueprint $table) {
                $table->id();
                $table->foreignId('tenant_id')->index()->onDelete('cascade');
                $table->string('name');
        ...
        Schema::create('timetable_slots', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->index()->onDelete('cascade');
            $table->foreignId('timetable_id')->index()->onDelete('cascade');
            ...
            $table->foreignId('classroom_id')->nullable()->index()->onDelete('set null');
