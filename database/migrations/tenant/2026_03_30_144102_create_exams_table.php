...
return new class extends Migration
{
    public function up()
    {
        Schema::create('exams', function (Blueprint $table) {
            ...
            $table->foreign('teacher_id')->references('id')->on('users')->onDelete('cascade'); // Changé teachers -> users
        ...
        Schema::create('exam_results', function (Blueprint $table) {
            ...
            $table->foreign('student_id')->references('id')->on('users')->onDelete('cascade'); // Changé students -> users
