...
return new class extends Migration
{
    public function up()
    {
        Schema::create('class_assignments', function (Blueprint $table) {
            ...
            // Garder tenant_id mais SANS clé étrangère (commentée)
            ...
            // Foreign keys - La clé vers tenants est COMMENTÉE
...
//             //       ->onDelete('cascade');
            ...
            // Unique constraint - Commenter ou modifier celle avec tenant_id
