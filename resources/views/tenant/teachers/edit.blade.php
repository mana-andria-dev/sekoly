...
<div class="mx-auto animate-fade-in">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-white">Modifier le professeur</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="last_name" required value="{{ old('last_name', $teacher->last_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="first_name" required value="{{ old('first_name', $teacher->first_name) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="date_of_birth" required value="{{ old('date_of_birth', $teacher->date_of_birth->format('Y-m-d')) }}"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="email" name="email" required value="{{ old('email', $teacher->email) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="status" required class="w-full bg-gray-800 border {{ $errors->has('status') ? 'border-red-500' : 'border-gray-700' }} rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-primary-600 focus:border-transparent">
                                ...
                                <option value="on_leave" {{ old('status', $teacher->status) == 'on_leave' ? 'selected' : '' }}>En congé</option>
                                <option value="retired" {{ old('status', $teacher->status) == 'retired' ? 'selected' : '' }}>Retraité</option>
                            </select>
                            @error('status')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="date" name="hire_date" required value="{{ old('hire_date', $teacher->hire_date->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <select name="employment_type" required class="w-full bg-gray-800 border {{ $errors->has('employment_type') ? 'border-red-500' : 'border-gray-700' }} rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-primary-600 focus:border-transparent">
                                <option value="CDI" {{ old('employment_type', $teacher->employment_type) == 'CDI' ? 'selected' : '' }}>CDI</option>
                                <option value="CDD" {{ old('employment_type', $teacher->employment_type) == 'CDD' ? 'selected' : '' }}>CDD</option>
                                <option value="Vacataire" {{ old('employment_type', $teacher->employment_type) == 'Vacataire' ? 'selected' : '' }}>Vacataire</option>
                                <option value="Contractuel" {{ old('employment_type', $teacher->employment_type) == 'Contractuel' ? 'selected' : '' }}>Contractuel</option>
                            </select>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="academic_degree" required value="{{ old('academic_degree', $teacher->academic_degree) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="specialization" required value="{{ old('specialization', $teacher->specialization) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="id_number" value="{{ old('id_number', $teacher->id_number) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="social_security_number" value="{{ old('social_security_number', $teacher->social_security_number) }}"
