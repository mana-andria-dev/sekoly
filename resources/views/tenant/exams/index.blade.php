...
<div class="mx-auto animate-fade-in">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('exams.create', app('tenant')->name) }}"
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all">
            <div class="flex items-start justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('exams.edit', [app('tenant')->name, $exam->id]) }}"
                       class="p-2 text-gray-400 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                    </a>
                    <a href="{{ route('exams.results', [app('tenant')->name, $exam->id]) }}"
                       class="p-2 text-green-400 hover:text-green-300 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                    </a>
                    <form action="{{ route('exams.destroy', [app('tenant')->name, $exam->id]) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
