...
<div class="mx-auto animate-fade-in">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('homeworks.create', app('tenant')->name) }}"
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all">
            <div class="flex items-start justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('homeworks.edit', [app('tenant')->name, $homework->id]) }}"
                       class="p-2 text-gray-400 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                    </a>
                    <form action="{{ route('homeworks.destroy', [app('tenant')->name, $homework->id]) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
